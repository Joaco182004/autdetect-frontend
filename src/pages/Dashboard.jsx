...
export default function Dashboard() {
  ...
  return (
    <section className="bg-[rgba(134,185,221,0.5)] w-screen h-screen flex justify-center items-center">
      <section className="bg-[rgb(244,244,244)] w-screen h-screen max-w-[1500px]  max-h-[900px] flex items-center select-none container-main max-w-1080:flex-col relative">
        {menu && (
          <>
            <section className="w-full h-full absolute bg-[rgba(0,0,0,0.5)] backdrop-blur-sm left-0 top-0 z-[9999]"></section>
            <section className="w-[350px] h-full absolute bg-white backdrop-blur-sm right-0 top-0 z-[10000]">
              <h1 className="font-playwrite text-blue-500 text-center font-bold w-[100%] h-[100px] mt-8 text-2xl">
                AutDetect
              </h1>
              <ul className="flex flex-col items-center w-full mt-1 max-w-1300:text-[0.95rem]">
                ...
                location.pathname == "/app/evaluaciones/mchat" ? (
                  <li
                    onClick={() => {
                ...
                <li
                  onClick={() => {
                    onOpen(); // Llamamos a la función que ya tenías
                    setMenu(false); // Cerramos el menú
                  }}
                  className="group hover:bg-[rgb(244,244,244)] hover:shadow-md cursor-pointer p-[10px] rounded-md flex items-center w-[90%] mb-2 hover:font-semibold"
                >
        ...
        <nav className="bg-white w-full h-24 hidden justify-between items-center max-w-1080:flex">
          ...
          <div className="bg-gray-100 rounded-full px-4 py-2 relative flex justify-center font-montserrat max-w-780:hidden">
          ...
          <div onClick={onOpen} className="mr-8 max-w-780:hidden">
          ...
          <Bars3Icon
            ...
            className="hidden max-w-780:block w-14 mr-8 text-blue-500"
          ></Bars3Icon>
        </nav>
